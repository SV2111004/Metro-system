...
|  **Akshat** | [@Akshat](https://github.com/Akshat-1618) | 🔹 Implemented **All Paths feature** using DFS<br>🔹 Designed **user movement tracking** for going back to previous station | ➕ Helped **Janvi** in connecting travel actions with **fare deduction logic** |
|  **Janvi** |[@Janvi](https://github.com/JanviArora24) | 🔹 Developed **nearest washroom/parking station** finder using BFS<br>🔹 Handled **login/signup system** and **metro card recharge/deduction** | ➕ Coordinated with **Akshat** for **card balance tracking** after station movement |
